...
class AntiMassMention(commands.Cog):
    ...
    async def log_action(self, guild, user, channel, action, reason):
        ...
        if log_channel_id and log_channel_id[0]:
            ...
            if log_channel:
                embed = discord.Embed(title="Automod Log: Anti Mass Mention", color=0x525252)
    ...
    async def on_message(self, message):
        ...
        if mention_count >= self.mass_mention_threshold:
            ...
            try:
                ...
                simple_embed = discord.Embed(title="Automod Anti Mass-Mention", color=0x525252)
                ...
                simple_embed.set_footer(text="Powered By Zyn AutoModeration.", icon_url=self.bot.user.avatar.url)
